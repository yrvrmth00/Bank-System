...
title_core = '''
  ...
  / ____| |     | |             |  _ \            | |        /\      | |         (_)      
 | |  __| | ___ | |__   ___  ___| |_) | __ _ _ __ | | __    /  \   __| |_ __ ___  _ _ __  
 | | |_ | |/ _ \| '_ \ / _ \/ _ \  _ < / _` | '_ \| |/ /   / /\ \ / _` | '_ ` _ \| | '_ \ 
 | |__| | | (_) | |_) |  __/  __/ |_) | (_| | | | |   <   / ____ \ (_| | | | | | | | | | |
  \_____|_|\___/|_.__/ \___|\___|____/ \__,_|_| |_|_|\_\ /_/    \_\__,_|_| |_| |_|_|_| |_|
                                GlobeeBank Admin Control Panel                           
...
os.system('cls||clear')
print('''GlobeeBank-Admin-Control-Panel [Version '''+version+'''] - Platform '''+platform+'''   ''')
...
def main():
    sys.stdout.write("\x1b]2;GlobeeBank Admin Control Panel\x07")
    sys.stdout.flush()
